...
class ConplateFrameworkBundle extends AbstractBundle
{
    ...
    public function loadExtension(array $config, ContainerConfigurator $container, ContainerBuilder $builder): void
    {
        ...
        $container->parameters()
            ...
            ->set('conplate.content.button_style.options', $config['content']['button_style']['options'])
            ->set('conplate.content.button_style.reference', $config['content']['button_style']['reference'])
            ->set('conplate.content.button_style.default', $config['content']['button_style']['default'])
            ->set('conplate.content.button_size.options', $config['content']['button_size']['options'])
            ->set('conplate.content.button_size.reference', $config['content']['button_size']['reference'])
            ->set('conplate.content.button_size.default', $config['content']['button_size']['default'])
